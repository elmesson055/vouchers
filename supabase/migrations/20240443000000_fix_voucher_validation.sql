...
-- Function to validate common voucher
...
BEGIN
    -- Try to validate common voucher
...
GRANT EXECUTE ON FUNCTION validate_common_voucher(VARCHAR, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION validate_common_voucher(VARCHAR, UUID) TO anon;
